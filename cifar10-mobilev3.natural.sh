...
# CIFAR-10
# resnet18
echo $SHELL_FOLDER/experiments/CIFAR10/mobilenetv2.natural/
cd $SHELL_FOLDER/experiments/CIFAR10/mobilenetv2.natural/

for i in $(seq 1 5)
do
    python3 train.py
    # save the result
    mkdir -p $SHELL_FOLDER/results/cifar10/mobilenetv3/$i/
    cp ./log/models/last.checkpoint $SHELL_FOLDER/results/cifar10/mobilenetv3/$i/natural.checkpoint
done
