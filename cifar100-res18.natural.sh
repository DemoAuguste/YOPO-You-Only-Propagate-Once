...
# CIFAR-100
# resnet18
echo $SHELL_FOLDER/experiments/CIFAR100/pre-res18.natural/
cd $SHELL_FOLDER/experiments/CIFAR100/pre-res18.natural/
...
do
    ...
    cp ./log/models/last.checkpoint $SHELL_FOLDER/results/cifar100/res18/$i/natural.checkpoint
done
