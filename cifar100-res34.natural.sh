...
# resnet34
echo $SHELL_FOLDER/experiments/CIFAR100/wide34.natural/
cd $SHELL_FOLDER/experiments/CIFAR100/wide34.natural/
for i in $(seq 1 5)
do
    python3 train.py
    # save the result
    mkdir -p $SHELL_FOLDER/results/cifar100/res34/$i/
    cp ./log/models/last.checkpoint $SHELL_FOLDER/results/cifar100/res34/$i/natural.checkpoint
done