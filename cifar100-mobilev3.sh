...
# CIFAR-10
# resnet18
echo $SHELL_FOLDER/experiments/CIFAR100/mobilenetv2.pgd10/
cd $SHELL_FOLDER/experiments/CIFAR100/mobilenetv2.pgd10/
...
do
    ...
    cp ./log/models/last.checkpoint $SHELL_FOLDER/results/cifar100/mobilenetv3/$i/last.checkpoint
done
